...
This project builds on Nir Yemini’s foundational work analyzing Israeli academic institutions' strategic behavior. 
While his research focused on institutional policies and positioning in global academia, our work extends the analysis to the public discourse dimension — examining how universities communicate cooperation and competition through their own media output.
...
|------------------------|-----------------------------------------------------------------------------|
| `institution`          | Publishing university name                                                  |
| `date`                | Date of article publication                                                 |
| `title`               | Article headline                                                            |
| `url`                 | URL to original article                                                     |
| `tone`                | One of: cooperative, competitive, neutral, or mixed                         |
| `mentions_cooperation`| TRUE/FALSE – whether article mentions cooperation                           |
| `mentions_competition`| TRUE/FALSE – whether article mentions competition                           |
| `cooperation_type`    | Type of cooperation (e.g., Domestic, International)                         |
| `thematic_tags`       | Content tags (semicolon-separated)                                          |
| `length_words`        | Estimated article length in words                                           |
